...
interface UpazilaMapSectionProps {
...
export function UpazilaMapSection({ mapData, districtId, upazilaId, upazilaName, isAdmin }: UpazilaMapSectionProps) {
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-xl font-semibold text-foreground">
                            {mapData?.title || `${upazilaName} Upazila Map`}
                        </h2>
                        {mapData?.description && (
            ...
            {!mapData && isAdmin && (
                <div className="border-2 border-dashed border-border rounded-lg p-12 text-center">
                    ...
                    <p className="text-muted-foreground mb-4">
                        Add a map to display locations for {upazilaName} upazila
                    </p>
